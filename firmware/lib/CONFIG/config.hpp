...
namespace Config {
    static constexpr byte SAMPLE_FREQ_HZ = 150;
    ...
    static constexpr byte GYRO_CALIBRATION_DELAY_MS = 5;
    ...
    static constexpr int MAIN_TASK_PRIORITY = 5;
    static constexpr int MAIN_TASK_CORE_ID = 0;

    static constexpr float EMA_ALPHA = 0.6f;
};