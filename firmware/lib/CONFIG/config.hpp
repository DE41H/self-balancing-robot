...
class Config {
    public:
        ...
        static constexpr double RPM_FACTOR = (60.0 * Config::SAMPLE_FREQ_HZ) / ENCODER_PPR;
        static constexpr byte PCNT_FILTER_VALUE = 100;

        static constexpr double SPEED_KP = 0.0;
        static constexpr double SPEED_KI = 0.0;
        static constexpr double SPEED_KD = 0.0;
